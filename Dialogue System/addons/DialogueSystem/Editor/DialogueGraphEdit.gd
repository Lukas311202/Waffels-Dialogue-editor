...
var current_file : String = "res://addons/DialogueSystem/Dialogues/Dialogue1.json"
...
func load_data(new_file : String):
	...
	if data.has("connections"):
		for i in data.connections:
			...
			if get_node(correct_from_name).filename != "res://addons/DialogueSystem/Editor/Nodes/QuestionNode.tscn":
...
func delete_current_file():
	...
	dir.open("res://addons/DialogueSystem/Dialogues/")
...
func change_file(new_file : String):
